...
public interface AccrualScheduleMilestoneRepository
    extends BaseRepository<AccrualScheduleMilestone, String> {

  @Query(
      "select m from AccrualScheduleMilestone m where m.timeOffPolicyAccrualScheduleId = ?1 "
  ...
  @Query(
      value =
          "update time_off_policy_accrual_schedule_milestones "
