...
public class Permission {
  ...
  public enum Name {
    ...
    VIEW_USER_ADDRESS(PermissionType.MANAGER_PERMISSION),
    ...
    SELECT_PAID_HOLIDAY(PermissionType.ADMIN_PERMISSION),
    ...
    VIEW_SELF_TIME_OFF_REQUEST(PermissionType.SELF_PERMISSION);
