...
class TimeOffRequestCustomRepositoryTests extends DataLayerBaseTests {
  ...
  @MockBean private TimeOffRequestCustomRepositoryImpl timeOffRequestCustomRepository;

  @Test
  void testGetFilteredReviewedTimeOffRequestsIds() throws Exception {
    final List<String> result = new ArrayList<>();
    given(
            timeOffRequestCustomRepository.getFilteredReviewedTimeOffRequestsIds(
  ...
  void testFindByTimeOffPolicyUserAndStatus() throws Exception {
    ...
    given(
            timeOffRequestCustomRepository.findByTimeOffPolicyUserAndStatus(
