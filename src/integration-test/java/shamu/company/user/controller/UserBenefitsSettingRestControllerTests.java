...
public class UserBenefitsSettingRestControllerTests extends WebControllerBaseTests {
  ...
  @MockBean private UserBenefitsSettingService benefitService;
  ...
  void testFindUserBenefitsEffectYear() throws Exception {
    ...
    final MvcResult response =
        mockMvc
            .perform(
                MockMvcRequestBuilders.get("/company/benefits-setting/effect-year/2020")
                    .headers(httpHeaders))
            .andReturn();
  ...
  void testSaveUserBenefitsEffectYear() throws Exception {
    ...
    final MvcResult response =
        mockMvc
            .perform(
                MockMvcRequestBuilders.patch("/company/benefits-setting/effect-year")
