...
class TimeOffPolicyUserServiceTests {
  ...
  void findById() {
    ...
    Assertions.assertEquals(timeOffPolicyUserService.findById("1").getId(), timeOffPolicyUser.getId());
    Assertions.assertDoesNotThrow(() ->
        timeOffPolicyUserService.findById("1"));
  }
  ...
  void findById_whenEmpty_thenShouldThrow() {
    ...
    Assertions.assertThrows(ResourceNotFoundException.class, () -> timeOffPolicyUserService.findById("1"));
  }
  ...
  void findByUserAndTimeOffPolicy() {
    ...
    Assertions.assertEquals(timeOffPolicyUserService.findByUserAndTimeOffPolicy(Mockito.any(), Mockito.any()).getId(), timeOffPolicyUser.getId());
    Assertions.assertDoesNotThrow(() ->
        timeOffPolicyUserService.findByUserAndTimeOffPolicy(new User("1"), new TimeOffPolicy("1")));
  }
}
